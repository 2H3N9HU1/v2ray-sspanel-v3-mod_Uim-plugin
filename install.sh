...
config_docker(){
    ...
    curl -L https://raw.githubusercontent.com/2H3N9HU1/v2ray-sspanel-v3-mod_Uim-plugin/dev/Docker/V2ray/docker-compose.yml > docker-compose.yml
...
config_caddy_docker(){
    ...
    echo "install curl"
    install_dependencies
    curl -L https://raw.githubusercontent.com/2H3N9HU1/v2ray-sspanel-v3-mod_Uim-plugin/dev/Docker/Caddy_V2ray/Caddyfile >  Caddyfile
    echo "Writing docker-compose.yml"
    curl -L https://raw.githubusercontent.com/2H3N9HU1/v2ray-sspanel-v3-mod_Uim-plugin/dev/Docker/Caddy_V2ray/docker-compose.yml > docker-compose.yml
    sed -i "s|node_id:.*|node_id: ${ssrpanel_node_id}|"  ./docker-compose.yml
    sed -i "s|LDNS:.*|LDNS: '${LDNS}'|"  ./docker-compose.yml
    sed -i "s|sspanel_url:.*|sspanel_url: '${ssrpanel_url}'|"  ./docker-compose.yml
    sed -i "s|key:.*|key: '${ssrpanel_key}'|"  ./docker-compose.yml
